...
const Morpion = () => {
    ...
    const toggle = (e,num)=>{
        ...
        const checkWin=()=> {
            ...
            else if (data[6]===data[7] && data[7]===data[5] && data[5]!=="")
            {
                won(data[5]);
            }
    ...
    const reset=()=>{
        setLock(false);
        data=["","","","","","","",""];
        titleRef.current.innerHTML = 'Do you want to play ? <span>#React</span>';
        box_array.map((e)=>{
        })
    ...
    return (
        <div className='container'>
            <h1 className="title" ref={titleRef}>Do you want to play ? <span>#React</span> </h1>
            <div className="board">
                <div className="row1">
